...
abstract class Addons
{
    ...
    public function __construct()
    {
        $name = $this->getName();
        // 获取当前插件目录
        $this->addons_path = APP_PATH . $name . DS;
    ...
    public function init(){
        ...
        $this->view = \sowers\View::config($config, Config::get('template.custom'));
        return $this;
    }
    ...
    final public function getInfo($name = '')
    {
        ...
        $info_file = $this->addons_path . 'conf.ini';
